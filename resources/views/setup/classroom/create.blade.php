...
@section('content')
    <section class="section">
        <x-bread-crumb title="Classroom">
            ...
            <div class="breadcrumb-item">Create Classroom</div>
        </x-bread-crumb>
    </section>
                    ...
                    <form action="{{ route('classroom.store') }}" id="createForm" method="POST">
                        ...
                        <div class="form-row mb-2">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Class A">
                            </div>
                            <div class="form-group col-md-6">
                                <label>Status</label>
                        ...
                        <div class="form-row mb-2">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control start-date" name="start_date" placeholder="">
                            </div>
                            <div class="form-group col-md-6">
                                <label>End Date</label>
                                <input type="text" class="form-control end-date" name="end_date" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-5">
                            ...
                            <textarea name="description" class="form-control" id="" rows="8">{{ old('description') }}</textarea>
                        </div>
